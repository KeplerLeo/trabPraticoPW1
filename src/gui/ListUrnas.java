 ...
 * @author Leonardo
 */
public class ListUrnas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListUrnas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
